            ...
            <form className="review-form" >
              ...
              <div className="separated with-flex">                
                ...
                <div className="star-box">
                  ...
                  <div onClick={this.handleClick(4)}className="star star-4" id={ this.state.rating >=5 ? `star-${this.state.rating}`: ""}>★</div>
                  <div onClick={this.handleClick(3)}className="star star-3" id={ this.state.rating >=5 ? `star-${this.state.rating}`: ""}>★</div>
                  <div onClick={this.handleClick(2)}className="star star-2" id={ this.state.rating >=5 ? `star-${this.state.rating}`: ""}>★</div>
                  <div onClick={this.handleClick(1)}className="star star-1" id={ this.state.rating >=5 ? `star-${this.state.rating}`: ""}>★</div>
                </div>
              </div>
              <div className="separated">                
